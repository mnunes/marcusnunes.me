...
tags: ["análise", "ciência de dados", "esporte", "nba", "r", "tutorial", "visualização"]
draft: false
...
O código completo desta análise (menos os dados) está disponível em meu [github](https://github.com/mnunes/nba_viz).
