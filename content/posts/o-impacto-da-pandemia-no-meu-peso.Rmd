...
* 15 de Janeiro de 2021: só passei a ter mais consistência em meu emagrecimento a partir da ida à minha nutricionista. Estou fazendo uma dieta com baixa ingestão de carboidratos e o resultado tem sido bastante bom: `r dados[dados$Date==ymd("2021-01-15"), ][2]-dados[dados$Date==ymd("2021-02-19"), ][2]`kg a menos em 6 semanas (ou 42 dias). 
